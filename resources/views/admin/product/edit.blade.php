...
@section('content')
    <div class="container-fluid">
        ...
        <form id="form" action="{{ route('admin.product.update', $product->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="slug" name="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') ?: $product->slug }}" readonly>
                                @error('slug')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea id="details" name="details" class="form-control @error('details') is-invalid @enderror">{{ old('details') ?: $product->details }}</textarea>
                                @error('details')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col form-group">
                                    ...
                                    <input type="number" min="0" id="price" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') ?: $product->price }}">
                                    @error('price')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col form-group mb-0">
                                    ...
                                    <input type="number" min="0" id="compare_price" name="compare_price" class="form-control @error('compare_price') is-invalid @enderror" value="{{ old('compare_price') ?: $product->compare_price }}">
                                    @error('compare_price')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col form-group">
                                    ...
                                    <input type="text" id="barcode" name="barcode" class="form-control @error('barcode') is-invalid @enderror" value="{{ old('barcode') ?: $product->barcode }}">
                                    @error('barcode')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" id="track_qty" name="track_qty" class="custom-control-input" value="Yes" {{ (old('track_qty') ?: $product->track_qty) == 'Yes' ? 'checked': null }}>
                                    <label for="track_qty" class="custom-control-label">Track Quantity</label>
                                </div>
                                <input type="number" min="0" id="qty" name="qty" class="form-control @error('qty') is-invalid @enderror" value="{{ old('qty') ?: $product->qty }}">
                                @error('qty')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <select id="status" name="status" class="form-control">
                                    ...
                                    <option {{ (old('status') ?: $product->status) == 1 ? 'selected' : null }} value="1">Active</option>
                                    <option {{ (old('status') ?: $product->status) == 0 ? 'selected' : null }} value="0">Block</option>
                                </select>
                                @error('status')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select id="category_id" name="category_id" class="form-control">
                                    ...
                                    @foreach ($categories as $item)
                                        <option {{ (old('category_id') ?: $product->category_id) == $item->id ? 'selected' : null }} value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                    <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select id="sub_category_id" name="sub_category_id" class="form-control">
                                    ...
                                    @foreach ($subcategories as $item)
                                        <option {{ (old('sub_category_id') ?: $product->sub_category_id) == $item->id ? 'selected' : null }} value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-0">
                                <select id="brand_id" name="brand_id" class="form-control">
                                    ...
                                    @foreach ($brand as $item)
                                        <option {{ (old('brand_id') ?: $product->brand_id) == $item->id ? 'selected' : null }} value="{{ $item->id }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                                @error('brand_id')
                                    <small class="text-danger">{{ $message }}</small>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <img src="{{ asset('uploads/products/'.$product->image) }}" id="image-preview" class="mb-3" width="180" alt="image">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <select id="is_featured" name="is_featured" class="form-control">
                                    <option {{ (old('is_featured') ?: $product->is_featured) == 'No' ? 'selected' : null }} value="No">No</option>
                                    <option {{ (old('is_featured') ?: $product->is_featured) == 'Yes' ? 'selected' : null }} value="Yes">Yes</option>
                                </select>
                            </div>
                        </div>
                    </div>
