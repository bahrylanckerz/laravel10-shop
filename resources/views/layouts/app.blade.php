...
<head>
    <meta charset="utf-8">
    <title>@yield('title') - Bahri Shop</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Laravel Bahri Shop" name="keywords">
    <meta content="Laravel 10 Bahri Shop Project" name="description">
    ...
    <div class="container-fluid">
        <div class="row bg-secondary py-1 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center d-block d-lg-none mr-3">
                    ...
                    <a href="" class="btn px-0 ml-2">
                        ...
                        <span class="badge text-dark border border-dark rounded-circle" style="padding-bottom: 2px;">{{ cartCount() ?: 0 }}</span>
                    </a>
                </div>
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        @else
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item text-dark" href="#">Login</a>
                                <a class="dropdown-item text-dark" href="#">Register</a>
                            </div>
                        @endauth
                    </div>
                </div>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">Bahri</span>
                ...
                <form action="" method="get">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button type="submit" class="input-group-text bg-secondary text-primary">
                    ...
                    <div class="navbar-nav w-100">
                        @if (getCategories()->isNotEmpty())
                            @foreach (getCategories() as $category)
                                @if (getSubCategories($category->id)->isNotEmpty() > 0)
                                    <div class="nav-item dropdown dropright">
                                        ...
                                        <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                            @foreach ($category->sub_categories as $subcategory)
                                                <a href="{{ route('category', $subcategory->slug) }}" class="dropdown-item text-dark">{{ $subcategory->name }}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                @else
                                    <a href="{{ route('category', $category->slug) }}" class="nav-item nav-link">{{ $category->name }}</a>
                                @endif
                            @endforeach
                        @endif
                    </div>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Bahri</span>
                        <span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">Shop</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('product', 'product-slug') }}" class="nav-item nav-link">Shop Detail</a>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="{{ asset('assets/home/img/payments.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
